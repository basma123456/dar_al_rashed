...
//    return response()->json($filesData);});
    ...
    /******************categories**********/
    Route::get('categories/{module}', [CategoryController::class, 'index'])->name('cats.index');
    Route::get('categories/add/{module}', [CategoryController::class, 'add'])->name('cats.add');
    ...
    /**************roles permissions*********/
    Route::get('roles-permissions/{role}', [RolePermissionController::class, 'index'])->name('roles_permissions_index');
    Route::post('roles-submit/{role}', [RolePermissionController::class, 'updateOrCreate'])->name('roles_permission_store_update');
    /*****************roles permissions*************/
});
