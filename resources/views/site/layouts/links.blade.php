<head>
    ...
    <title>الرئيسية | دار راشد للنشر</title>
    ...
    <link rel="stylesheet" href="{{asset('site/assets/vendors/aos/css/aos.css')}}" />
    ...
    <link rel="stylesheet" href="{{asset('site/assets/vendors/rashed-icons/style.css')}}" />
    <link rel="stylesheet" href="{{asset('site/assets/vendors/slick/slick.css')}}" />
    ...
    <script src="{{asset('site/js/header.js')}}"></script> <!---here-->
