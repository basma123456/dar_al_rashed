...
{{--                            "7" => array('can_do' => "show_print", 'can_do_label' => "Print Show Item - طباعه عرض العنصر " , "can_do_label_ar" => 'طباعة عرض عنصر'  , "can_do_label_en" => 'Print Item'),--}}
                            ...
                            @forelse($modules as $item)
                                @php $perms = isset($item->roleModule[0]) ?  json_decode($item->roleModule[0]->permissions) : [] @endphp
                                  <div class="col-12">
                                    <div class="w-100 border rounded p-3 shadow-lg">

                                        <div class="form-check mb-3 pb-2 collection-head">
                                            <input class="form-check-input"    {{in_array('show' , $perms) ? 'checked' : ''}}  name="module[{{$item->id}}][]" type="checkbox" value="show"  id="users">
                                            <label class="form-check-label ms-2 fw-bold" for="users">
                                                {{$item->$name}}

                                                <input type="hidden" value="{{$item->id}}" name="module_id[{{$item->id}}]">
                                                <input type="text" value="{{optional($item->roleModule)->id ?? 0}}"   name="role_module_id[{{$item->id}}]">

                                                <input type="hidden" name="role_id" value="{{$role->id}}">

{{--                                                <input class="form-check-input child d-none" name="module[{{$item->id}}][mod_id]" type="checkbox" checked  value="{{$item->id}}"--}}
{{--                                                             id="users-role-perm">--}}
                                            </label>
                                        </div>
                                        <div class="row users-inputs">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-12">
                                                <div class="form-check">
                                                    <input class="form-check-input child" name="module[{{$item->id}}][]" type="checkbox" value="add"
                                                           {{in_array('add' , $perms) ? 'checked' : ''}}
                                                           id="users-add">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-12">
                                                <div class="form-check">
                                                    <input class="form-check-input child" name="module[{{$item->id}}][]" type="checkbox" value="edit"
                                                           {{in_array('edit' , $perms) ? 'checked' : ''}}        id="users-edit">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-12">
                                                <div class="form-check">
                                                    <input class="form-check-input child" name="module[{{$item->id}}][]" type="checkbox" value="delete"
                                                           {{in_array('delete' , $perms) ? 'checked' : ''}}            id="users-del">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-12">
                                                <div class="form-check permissions-inputs-margin-top">
                                                    <input class="form-check-input child" name="module[{{$item->id}}][]" type="checkbox" value="active"
                                                           {{in_array('active' , $perms) ? 'checked' : ''}}        id="users-role-perm">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-12">
                                                <div class="form-check permissions-inputs-margin-top">
                                                    <input class="form-check-input child" name="module[{{$item->id}}][]" type="checkbox" value="print"
                                                           {{in_array('print' , $perms) ? 'checked' : ''}}       id="users-role-perm">
...
{{--                                            <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                <div class="form-check permissions-inputs-margin-top">--}}
{{--                                                    <input class="form-check-input child" name="module[{{$item->id}}][list]" type="checkbox" value="list"--}}
...
{{--                                                  <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                      <div class="form-check">--}}
{{--                                                          <input class="form-check-input child" name="module[{{$item->id}}][add]" type="checkbox" value="add"--}}
...
{{--                                            <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                <div class="form-check">--}}
{{--                                                    <input class="form-check-input child" name="module[{{$item->id}}][edit]" type="checkbox" value="edit"--}}
...
{{--                                            <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                <div class="form-check">--}}
{{--                                                    <input class="form-check-input child" name="module[{{$item->id}}][delete]" type="checkbox" value="delete"--}}
...
{{--                                            <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                <div class="form-check permissions-inputs-margin-top">--}}
{{--                                                    <input class="form-check-input child" name="module[{{$item->id}}][active]" type="checkbox" value="active"--}}
...
{{--                                            <div class="col-lg-3 col-md-6 col-12">--}}
{{--                                                <div class="form-check permissions-inputs-margin-top">--}}
{{--                                                    <input class="form-check-input child" name="module[{{$item->id}}][print]" type="checkbox" value="print"--}}
