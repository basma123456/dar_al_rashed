{{--<!---------------------->--}}
{{--{{ $data->postLangsCurrent->$name }}--}}
{{--@if ($data->module != 'pages')--}}
{{--    <div--}}
{{--        class="col-sm-6 col-12 d-flex justify-content-end ">--}}
...
{{--                        {{$key}}--}}
                            ...
                            <div class="container p-4" id="arabicForm"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if ($nms[$ii] != "add_date"   && $nms[$ii] !== 'add_date2') { ?>
                                        ...
                                        <input type="text" style="direction:rtl;"
                                               ...
                                               class="form-control"
                                               value="<?php echo $v; ?> "/>
                                        <?php } elseif($nms[$ii] === 'add_date2'){?>
                                        <input type="date" style="direction:rtl;"
                                               name="txt_ar<?php echo $ii; ?>"

                                               class="form-control"
                                               value="<?php echo  date_create($v)->format('Y-m-d')  ?>"/>
                                       <?php }
                                    ...
                                    @if ($data->moduleRelation->have_short == 'yes')
                                        @include('admin.components.posts.edit.have_short_ar' , ['postLang' => $postLang   ])
                                    @endif

                                    @if ($data->moduleRelation->have_details == 'yes' )
                                        @include('admin.components.posts.edit.have_details_ar' , ['postLang' =>  $postLang  ])
                                    @endif
                            ...
                            <div class="container p-4  d-none" id="englishForm"
                                ...
                                <div class="row g-3">
                                    ...
                                    @if ($data->moduleRelation->have_cats == 'yes')
                                        @include('admin.components.posts.edit.cats', ['data' => $data])
                                    @endif
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php } elseif(  $nms[$ii] === "add_date2"){?>
                                        <input
                                               name="txt<?php echo $ii; ?>"
                                               type="date"
                                               class="form-control"
                                               value="<?php echo date_create($v2 )->format('Y-m-d'); ?>"/>
                                    ...
                                    @if ($data->moduleRelation->have_short == 'yes')
                                        @include('admin.components.posts.edit.have_short' , ['postLang' => $postLang])
                                    @endif



                                    @if ($data->moduleRelation->have_details == 'yes')
                                        @include('admin.components.posts.edit.have_details' , ['data' => $data  ,  'postLang' => $postLang])
                                    @endif



                                    @if ($data->moduleRelation->have_pic == 'yes')
                                        @include('admin.components.posts.edit.have_pic' , ['data' => $data ])
                                    @endif
                                    {{--                                        @if ($data->moduleRelation->up > 0 and Request::segment(4) == 1)--}}


                                    @if ($data->moduleRelation->up > 0  )
                                        @include('admin.components.posts.edit.up' , ['data' => $data ])
                                    @endif



                                    @if ($data->moduleRelation->have_more_fields == 'yes')
                                        @include('admin.components.posts.edit.have_more_fields' , ['data' => $data ])
                                    @endif
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2 flex-column flex-md-row">
                        <a type="reset"
                           href="{{url(route('admin.posts.edit' , ['module' => $data->moduleRelation->title , 'id' => $id]))}}"
                           class="btn main-btn reset-btn fw-bold">إعادة تعيين</a>
                        <button type="submit" class="btn main-btn edit-btn fw-bold">تعديل</button>
