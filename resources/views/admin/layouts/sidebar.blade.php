                    ...
                    <div class="sidebar-links-dropdown position-relative collapse" id="{{$mod->title}}">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                ...
                                <a href="{{url(route('admin.module.show.param' , ['title' => $mod->title , 'status' => 'yes']))}}"
                                   class="side-nav-link">
                                            <span class="sub-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="none" stroke="black" stroke-width="2" stroke-linecap="round"
                            ...
                            <li class="side-nav-item">
                                <a href="{{url(route('admin.module.show.param' , ['title' => $mod->title , 'status' => 'no']))}}"
                                   class="side-nav-link">
                                            <span class="sub-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="none"
                            ...
                            <li class="side-nav-item">
                                <a href="{{url(route('admin.posts.create' , ['module' => $mod->title  ]))}}"
                                   class="side-nav-link">
                                            <span class="sub-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="none" stroke="black" stroke-width="2" stroke-linecap="round"
                            ...
                            @if($mod->have_cats == 'yes')
                            <li class="side-nav-item">
                                <a href="{{url(route('admin.cats.index' , ['module' => $mod->title  ]))}}"
                                   class="side-nav-link">
                                            <span class="sub-icon me-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="none" stroke="black" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <span class="menu-text">@lang('admin.show_cats')</span>
                                </a>
                            </li>
                            @endif
