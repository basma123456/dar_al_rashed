...
@section('content')
    <div class="page-container pt-3">
        ...
        <div class="row">
            ...
            <form action="{{ route('admin.cats.store' , [ 'module'=> $module  ]) }}" method="POST"
                    ...
                    <div class="container p-4" id="arabicForm"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" required name="name_ar" style="direction:rtl "
                                       class="form-control" value="{{old('name_ar')}}" id="inputPassword">
                            </div>
                ...
                <div class="col-12  d-flex justify-content-end ">
                    ...
                    <a class="btn btn-success mt-10" href="{{route('admin.cats.index' , ['module' => $module])}}">الرجوع للقائمة</a>
                </div>
            </form>
